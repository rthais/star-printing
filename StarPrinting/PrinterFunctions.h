...
+ (void)PrintKanjiSampleReceipt4InchWithPortname:(NSString *)portName
                                    portSettings:(NSString *)portSettings;
+ (void)PrintCHSSampleReceipt3InchWithPortname:(NSString *)portName
                                  portSettings:(NSString *)portSettings;
+ (void)PrintCHSSampleReceipt4InchWithPortname:(NSString *)portName
                                  portSettings:(NSString *)portSettings;
+ (void)PrintCHTSampleReceipt3InchWithPortname:(NSString *)portName
                                  portSettings:(NSString *)portSettings;
...
+ (void)PrintRasterKanjiSampleReceipt4InchWithPortname:(NSString *)portName
                                          portSettings:(NSString *)portSettings;
+ (void)PrintRasterCHSSampleReceipt3InchWithPortname:(NSString *)portName
                                        portSettings:(NSString *)portSettings;
+ (void)PrintRasterCHSSampleReceipt4InchWithPortname:(NSString *)portName
                                        portSettings:(NSString *)portSettings;
+ (void)PrintRasterCHTSampleReceipt3InchWithPortname:(NSString *)portName
                                        portSettings:(NSString *)portSettings;
+ (void)PrintRasterCHTSampleReceipt4InchWithPortname:(NSString *)portName
                                        portSettings:(NSString *)portSettings;
